/**
 * File     : ApacheCommonsLogCreator.kt
 * License  :
 ...
 */
package com.contrastsecurity.cassandra.migration.internal.util.logging.apachecommons
 ...
 */
class ApacheCommonsLogCreator : LogCreator {
    override fun createLogger(clazz: Class<*>): Log {
        return ApacheCommonsLog(LogFactory.getLog(clazz))
    }
}
